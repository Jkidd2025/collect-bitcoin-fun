...
const FeatureSection = () => {
  const features = [
    ...
    },
    {
      ...
      description: "As a loyal $CBTC holder, our smart contract will automatically add more WBTC rewards to your wallet. WBTC rewards depend on market conditions and may decrease."
    },
    {
    ...
    <section id="features" className="py-20 relative overflow-hidden bg-crypto-medium">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          {/* Enhanced disclaimer with better visibility and styling */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.7 }}
            viewport={{ once: true }}
            className="mt-8 p-4 rounded-lg bg-amber-900/30 border border-amber-500/30"
          >
            <p className="text-amber-400 text-center font-medium flex items-center justify-center gap-2">
