...
import { Bitcoin, Twitter, Globe, MessageCircle, ArrowUp } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Collect Bitcoin ($CBTC) is the first memecoin on Solana that rewards holders with WBTC every minute.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-bitcoin transition-colors">Whitepaper</a></li>
